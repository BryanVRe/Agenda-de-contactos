...
import java.util.*;
class Items {
	//en este apartado no define el nombre de las variables y no se reconoce a que se hace referencia
    //utiliza la variable var en todos los metodos, puede definir una variable global y utilizarla en todos los metodos
	 boolean t1 , t2,t3;
  ...
  //Delete the specific person from the record
    ...
    public void deleteRecord () {
    	...
    	if(!(items.isEmpty())){
    		//variable repetida en todos los metodos, puede ponerla global
